...
var resizePizzas = function(size) {
  ...
  changeSliderLabel(size);
    ...
    function changePizzaSizes(size) {
      ...
      var resizeContainers = document.getElementsByClassName("randomPizzaContainer");
        for  (var i = 0; i < resizeContainers.length; i++) {
...
// calculate number of pizzas needed for browser window
var randColumns = Math.floor(window.innerWidth / 87.48);
...
function updatePositions() {
    ...
    var scrollVector = document.body.scrollTop / 1250;
    // i % 5 is simply five numbers  0 - 4
    // init array var for loop
    var phaseArray = [];
    for (var x = 0; x < 5; x++) {
        phaseArray[x] = (Math.sin(scrollVector + x) * 100)
    }
