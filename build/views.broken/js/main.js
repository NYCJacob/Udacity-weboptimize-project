...
var pizzaElementGenerator = function (i) {
    ...
    pizzaImage.classList.add("img-fluid");
...
function updatePositions() {
    ...
    var phaseArray = [(Math.sin(scrollVector) * 100),
        (Math.sin(scrollVector + 1) * 100),
        (Math.sin(scrollVector + 2) * 100),
        (Math.sin(scrollVector + 3) * 100),
